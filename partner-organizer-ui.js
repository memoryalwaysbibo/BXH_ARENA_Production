...
(function(root){
  ...
  function render(profile){
    ...
    return `<div class="partner-workspace"><div class="role-indicator">合作主辦｜${name} <button class="btn btn-ghost btn-sm" data-action="account-back-to-role">返回身分選擇</button></div><section class="auth-card"><h2>合作主辦工作台</h2><p>此身分已開通。方案與賽事權限將由 BXH 後台設定並於此顯示。</p><p class="hint">正式開賽與積分資格需通過後端授權檢查。</p></section></div>`;
  }
