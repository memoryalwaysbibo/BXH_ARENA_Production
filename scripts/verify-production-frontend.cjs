...
mustInclude('<div class="live-summary-stat"><b>${officialCount} 人</b><small>正式參賽</small></div>','Live compact participant summary must use officialCount');
mustInclude('class="panel live-summary-panel"','Compact live summary panel missing');
mustInclude('<div class="live-summary-stat"><b>${doneCount} / ${predictedTotal} 場</b><small>場次進度</small></div>','Compact live match progress summary missing');
mustNot(/<div class="stat-box"><div class="label">活動日期<\/div>/,'Live summary must not restore the large activity-date stat card');
