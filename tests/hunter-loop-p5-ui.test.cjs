...
if(source.includes("legacyPreviewUnsupported"))throw new Error('P5 must fail closed; legacy direct-join fallback is forbidden');
if(source.includes("目前系統正在切換新版票券確認流程"))throw new Error('P5 must not offer direct-join rollout fallback after backend deployment');
console.log('PASS HUNTER LOOP P5 fail-closed preview guard');
